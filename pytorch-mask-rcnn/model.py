...
class MaskRCNN(nn.Module):
    ...
    def set_log_dir(self, model_path=None):
        ...
        print('Directory for training logs')
        print('self.model_dir:',self.model_dir)
        print('path',"{}{:%Y%m%dT%H%M}".format(self.config.NAME.lower(), now))
    ...
    def train_model(self, train_dataset, val_dataset, learning_rate, epochs, layers):
        ...
        for epoch in range(self.epoch+1, epochs+1):
            ...
            print('self.checkpoint_path.format(epoch)',self.checkpoint_path.format(epoch))
            print('self.log_dir',self.log_dir)
